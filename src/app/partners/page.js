        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl border p-6">
            ...
            <div className="mt-4 flex flex-col gap-3">
              <a href={stripeLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl border px-4 py-2 hover:bg-neutral-50">
                Pay $599/year (Stripe)
              </a>
              <a href="/partners/apply" className="inline-flex items-center justify-center rounded-xl border px-4 py-2 hover:bg-neutral-50">
                Apply & get invoiced
              </a>
            </div>
